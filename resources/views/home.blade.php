    ...
    <div class="grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-4">
        @foreach ($products as $product)
            <a href="{{ route('products.show', [$product->slug]) }}"
                ...
                <img src="{{ $product->image_url }}" loading="lazy" class="object-cover absolute inset-0 z-0">
                <div
                    class="bg-gradient-to-t from-black/60 text-white pb-2 px-3 pt-6 absolute bottom-0 left-0 right-0 z-[2] transition-opacity opacity-0 group-hover:opacity-100">
