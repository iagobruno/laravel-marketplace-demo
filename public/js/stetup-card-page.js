...
"use strict";
/*!******************************************!*\
  !*** ./resources/js/stetup-card-page.js ***!
  \******************************************/
...
var stripeKeys = JSON.parse(document.getElementById("stripe-keys").innerText);
var stripe = Stripe(stripeKeys.stripe_pub_key);
...
function _handleSubmit() {
  _handleSubmit = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var _yield$stripe$confirm, setupIntent, error, pmInput;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            return _context.abrupt("return", alert(error.message));
